		...
		<div class="row gutters">
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
				<div class="pricing-plan">
					...
					<div class="pricing-footer">
						<a href="login.php" class="btn btn-primary btn-lg">Selecionar Plano</a>
					</div>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
				<div class="pricing-plan">
					...
					<div class="pricing-footer">
						<a href="login.php" class="btn btn-danger btn-lg">Selecionar Plano</a>
					</div>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
				<div class="pricing-plan">
					...
					<div class="pricing-footer">
						<a href="login.php" class="btn btn-success btn-lg">Selecionar Plano</a>
					</div>
				</div>
			</div>
		</div>
