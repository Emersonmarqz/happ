          ...
          <div class="card mt-3">
            <ul class="list-group list-group-flush">
              <li class="
                ...
                <span class="text-secondary">deividaraujo.com.br</span>
              </li>
              <li class="
                    list-group-item
                    d-flex
                ...
                <span class="text-secondary">Ojuara-B</span>
              </li>
              <li class="
                    list-group-item
                    d-flex
                ...
                <span class="text-secondary">@DeividA</span>
              </li>
              <li class="
                    list-group-item
                    d-flex
                ...
                <span class="text-secondary">Deivid_Araujo</span>
              </li>
              <li class="
                    list-group-item
                    d-flex
                ...
                <span class="text-secondary">Deivid Araujo</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="card mb-3">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-9 text-secondary">(81) 99380-4539</div>
              </div>
              <hr />
              <div class="row">
                <div class="col-sm-3">
